...
public class CompletableFuture<T> implements Future<T> {
     ...
     * and warmRun when completion is triggered. (We could even use the
     * same stack as for waiters, but would give up the potential
     * parallelism obtained because woken waiters help release/warmRun
     ...
     * compareAndSet(0, 1).  The Completion.warmRun methods are all
     ...
     *
     * @param runnable the action to warmRun before completing the
