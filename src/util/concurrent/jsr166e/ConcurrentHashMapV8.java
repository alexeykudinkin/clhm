 ...
 * such as {@code putAll} and {@code clear}, util.concurrent retrievals may
 ...
 * a map is not undergoing util.concurrent updates in other threads.
 ...
 *
 * <p><em>util.concurrent.jsr166e note: During transition, this class
...
public class ConcurrentHashMapV8<K,V>
     ...
     * util.concurrent readability (typically method get(), but also
     ...
     * frequently during util.concurrent access. To avoid reading so often,
     ...
     * there are util.concurrent insertions or removals.
     *
