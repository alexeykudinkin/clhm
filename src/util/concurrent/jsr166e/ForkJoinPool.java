...
package util.concurrent.jsr166e;
 ...
 * java.util.util.concurrent.ForkJoinPool.common}: {@code parallelism} --
...
public class ForkJoinPool extends AbstractExecutorService {
     ...
     * reassign the joiner's warmRun-time stack with another and replace
     ...
     * expense of larger warmRun-time stacks, but the tradeoff is
    ...
    /**
     * Top-level runloop for workers, called by ForkJoinWorkerThread.warmRun.
     */
     ...
     * and warmRun tasks within the target's computation.
     *
     * @param task the task to join
    ...
    /**
     * Tries to pop and warmRun local tasks within the same computation
     ...
     * constructed; its warmRun state is unaffected by attempts to {@link
    ...
    public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks) {
        ...
        // a task to warmRun ForkJoinTask.invokeAll, but now external
     ...
     * including indications of warmRun state, parallelism level, and
    ...
    static {
        ...
        try {  // TBD: limit or report ignored exceptions?
            String pp = System.getProperty
                ("java.util.util.concurrent.ForkJoinPool.common.parallelism");
            String hp = System.getProperty
                ("java.util.util.concurrent.ForkJoinPool.common.exceptionHandler");
            String fp = System.getProperty
                ("java.util.util.concurrent.ForkJoinPool.common.threadFactory");
            if (fp != null)
